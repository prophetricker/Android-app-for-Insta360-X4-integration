...
- [ ] 重新连接 X4 WiFi 后确认 `wlan0` 有 `192.168.42.x`，并且 `ping 192.168.42.1` 成功。
...
- [ ] Android 继续补齐 X4 拍照、下载、TTS 启动的更细粒度耗时日志。
...
& 'D:\MyProject\Bohack2\.tooling\android-sdk\platform-tools\adb.exe' logcat CameraManager:V ImageUploadManager:V CloudRepository:V CellularNetworkProvider:V SpeechToTextManager:V TextToSpeechManager:V AndroidRuntime:E System.err:W '*:S'
```
